...
class Agent():
    ...
    def __init__(self, num_agents, state_size, action_size, random_seed):
        ...
        self.critic_local = Critic(state_size, action_size, random_seed).to(Config.DEVICE)
        self.critic_target = Critic(state_size, action_size, random_seed).to(Config.DEVICE)
